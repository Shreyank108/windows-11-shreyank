...
document.querySelector("#TaskView").addEventListener("click",function(){ 
    document.querySelector(".terminal").style.display="initial"
})
document.querySelector(".terminal nav i").addEventListener("click",function(){ 
