window.addEventListener('scroll', function(event) {
    // Check if the page is currently being scrolled
    if (window.scrollY !== 0) {
        // If scrolled, prevent the default behavior (page reload)
        event.preventDefault();
        // Optionally, you can also reset the scroll position to the top
        // window.scrollTo(0, 0);
    }
});
